...
const SharemealWork = () => {
    ...
    return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        <Fade>
        <div className="bg-base-200 p-6 rounded-lg shadow hover:shadow-2xl transition">
        ...
        <div className="bg-base-200 p-6 rounded-lg shadow hover:shadow-2xl transition">
          ...
          <p className="text-gray-500">
            You help reduce waste and make someone’s day a little brighter. Every meal<br></br> shared counts!
          </p>
        </div>
        </Fade>
